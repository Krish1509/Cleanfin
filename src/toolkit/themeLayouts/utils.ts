...
interface ThemeState {
  ...
  layoutTheme:
    | LAYOUT_THEME.VERTICAL
    | LAYOUT_THEME.HORIZONTAL
    | LAYOUT_THEME.VERTICAL_TAB
    | LAYOUT_THEME.MODULER;
  themePreset:
  ...
  sidebarThemeCaptions:
    | SIDEBAR_THEME_CAPTION.CAPTION_SHOW
    | SIDEBAR_THEME_CAPTION.CAPTION_HIDE;
}
